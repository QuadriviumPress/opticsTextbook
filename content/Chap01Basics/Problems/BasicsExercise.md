...
**Problem 1.2** A photon has a wavelength of 550 nm (green light). Find its:
**(a)** frequency
**(b)** energy in joules
**(c)** energy in eV
**(d)** momentum

**Problem 1.3** An electron is accelerated from rest through a potential difference of 100 V. Calculate:
